...
export const EDITOR_SECTIONS: EditorSection[] = [
  // ---- Hulls ----
  {
    ...
    columns: [
      ...
      { key: 'damageTrack.stun', label: 'Stun', type: 'number', min: 0, width: 50 },
      { key: 'damageTrack.wound', label: 'Wound', type: 'number', min: 0, width: 55 },
      { key: 'damageTrack.mortal', label: 'Mortal', type: 'number', min: 0, width: 55 },
      { key: 'damageTrack.critical', label: 'Crit', type: 'number', min: 0, width: 50 },
