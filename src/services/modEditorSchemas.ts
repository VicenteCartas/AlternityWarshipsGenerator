...
export const EDITOR_SECTIONS: EditorSection[] = [
  ...
  // ---- Hangar & Misc ----
  {
    ...
    columns: [
      ...
      { key: 'hullPercentage', label: 'Hull %', type: 'number', min: 0, max: 100, width: 70, description: 'Percentage of hull used' },
      { key: 'hangarCapacity', label: 'Hangar Cap.', type: 'number', min: 0, width: 90, description: 'Hangar capacity in hull points per hull point allocated' },
      ...
      { key: 'prisonersCapacity', label: 'Prisoner Cap.', type: 'number', min: 0, width: 100, description: 'Prisoner capacity' },
      { key: 'scientistCapacity', label: 'Scientist Cap.', type: 'number', min: 0, width: 100, description: 'Scientist capacity' },
      ...
      { key: 'coveragePerHullPoint', label: 'Coverage/HP', type: 'number', min: 0, width: 100, description: 'Coverage percentage per hull point' },
      { key: 'effect', label: 'Effect', type: 'text', width: 250, description: 'Special effect description' },
      COL_DESC,
    ],
