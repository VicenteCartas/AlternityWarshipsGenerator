/**
 * Integration tests for WarshipsModule.tsx — the Warships Generator module.
 *
 * These tests render the full module with real hooks, real dataLoader (using
...
import { reloadAllGameData } from '@shared/services/dataLoader';
...
function renderApp() {
  return render(
    <ThemeProvider theme={theme}>
      <WarshipsModule themeMode="dark" onThemeModeChange={vi.fn()} />
    </ThemeProvider>,
  );
}
