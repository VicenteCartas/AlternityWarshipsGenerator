...
import { getEnginesData, getFuelTankData } from '@shared/services/dataLoader';
...
describe('engineService', () => {
  ...
  describe('calculateEnginePowerGenerated', () => {
    ...
    it('returns correct power when enabled with valid powerGeneratedPerHullPoint', async () => {
      const { getEngineAllowPowerGeneration } = await import('@shared/services/dataLoader') as unknown as { getEngineAllowPowerGeneration: ReturnType<typeof vi.fn> };
