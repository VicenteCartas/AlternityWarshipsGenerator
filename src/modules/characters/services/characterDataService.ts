...
import identityOptionsData from '../data/identityOptions.json';
...
const identityOptions = identityOptionsData as CharacterIdentityOptions;
...
export function getCharacterIdentityOptions(): CharacterIdentityOptions {
