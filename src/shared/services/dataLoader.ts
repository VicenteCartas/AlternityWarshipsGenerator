...
import type { TechTrackDefinition } from '@warships/types/common';
import type { Hull } from '@warships/types/hull';
import type { ArmorType, ArmorWeightConfig } from '@warships/types/armor';
import type { PowerPlantType, FuelTankType } from '@warships/types/powerPlant';
import type { EngineType } from '@warships/types/engine';
import type { FTLDriveType } from '@warships/types/ftlDrive';
import type { LifeSupportType, AccommodationType, StoreSystemType, GravitySystemType, ArtificialGravityRule } from '@warships/types/supportSystem';
import type { DefenseSystemType } from '@warships/types/defense';
import type { CommandControlSystemType } from '@warships/types/commandControl';
import type { SensorType, TrackingTable } from '@warships/types/sensor';
import type { HangarMiscSystemType } from '@warships/types/hangarMisc';
import type { LaunchSystem, PropulsionSystem, Warhead, GuidanceSystem } from '@warships/types/ordnance';
import type { BeamWeaponType, ProjectileWeaponType, TorpedoWeaponType, SpecialWeaponType, MountModifier, GunConfigModifier, MountType, GunConfiguration } from '@warships/types/weapon';

import type { DamageDiagramData } from '@warships/types/damageDiagram';
import type { Mod } from '../types/mod';
import { applyModsToFile } from './modMerge';
import { logger } from './utilities';

// Bundled data as fallback (imported at build time)
import hullsDataFallback from '@warships/data/hulls.json';
import armorDataFallback from '@warships/data/armor.json';
import powerPlantDataFallback from '@warships/data/powerPlants.json';
import fuelTankDataFallback from '@warships/data/fuelTank.json';
import enginesDataFallback from '@warships/data/engines.json';
import ftlDrivesDataFallback from '@warships/data/ftlDrives.json';
import supportSystemsDataFallback from '@warships/data/supportSystems.json';
import defensesDataFallback from '@warships/data/defenses.json';
import commandControlDataFallback from '@warships/data/commandControl.json';
import sensorsDataFallback from '@warships/data/sensors.json';
import hangarMiscDataFallback from '@warships/data/hangarMisc.json';
import ordnanceDataFallback from '@warships/data/ordnance.json';
import damageDiagramDataRaw from '@warships/data/damageDiagram.json';
...
import weaponsDataFallback from '@warships/data/weapons.json';
import techTracksDataFallback from '@warships/data/techTracks.json';
...
// ============== Mod Merge Utilities ==============
// Generic merge semantics live in modMerge.ts so every module shares them.
